            ...
            setInterval(function () {
                ...
                try {
                    ...
                    if (range) {
                        offset = {
                            range: range,
                            parent: typeof range.endContainer.parentNode != "undifined" ? range.endContainer.parentNode : null,
	...
	$(function () { // need access to jQuery UI stuff.
		...
		$.wysiwyg.dialog.register("default", function () {
			...
			this.init = function() {
				...
				that._$dialog = $('<div class="wysiwyg-dialog"></div>').css({"z-index": this.options.zIndex, 'border': "4px solid #525252"});
				...
				var dialogHeight = this.options.height == 'auto' ? 300 : this.options.height,
					dialogWidth = this.options.width == 'auto' ? 500 : this.options.width;
