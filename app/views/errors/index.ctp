	...
	<div id="wrap">
			...
			<div id="headerArea" class="clearfix">
				...
				<div id="headerRight">
					<div id="headerSub" class="clearfix">
						<ul id="headerSubNav">
							<li class="subLogout"><?php
							echo $html->link("ログアウト", array(
								'controller' => 'users',
								'action' => 'logout',
								'plugin' => null
							));
		...
		<div id="contents">
			...
			<div id="contentsArea" class="clearfix">
				<!-- <h2 class="mb20" >ただいまメンテナンス中です</h2> -->
				<h2 class="mb20"><?php
				echo h($title);
				?></h2>
				<div id="contentsCenter" class="mb60">
					<div id="contentsCenterTop">
						<div id="contentsCenterBtm">
							<div class="setupArea">
								<!-- <h1 style="font-size:15px; color:#FF0033;">ご不便をおかけしまして、申し訳ございません。</h1><br/>-->
